...
final class ValidationExceptionListener
{
    ...
    public function __invoke(ExceptionEvent $event): void
    {
        ...
        $data = $this->serializer->serialize(
            new ErrorResponse($throwable->getMessage(), $this->formViolations($throwable->getViolations())),
            JsonEncoder::FORMAT
        );
    ...
    private function formViolations(ConstraintViolationListInterface $violations): ErrorValidationDetails
    {
