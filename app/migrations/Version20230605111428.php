 ...
 */
final class Version20230605111428 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book_format ALTER title DROP NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE book_format ALTER title SET NOT NULL');
    }
}
